...
VALUES
    (1, 'bt0jTFZLyDYFCkQGoG4C95BjVOG3', 'Frodo Baggins', 'frodo.baggins@shire.com', SYSDATETIME(), NULL),
    (2, '2UCQGX4evDWC6Ysjrv2i3kMbFrO2', 'Pippin Took', 'peregrin.took@shire.com', SYSDATETIME(), NULL),
    (3, '34UcyayJiFXVsp9nMniT9BGzyuk1', 'Merry Brandybuck', 'meriadoc.brandybuck@shire.com', SYSDATETIME(), NULL);
